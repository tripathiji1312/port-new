        ...
        <RevealItem>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginTop: isMobile ? '2rem' : '4rem', flexWrap: 'wrap', gap: isMobile ? '1.5rem' : '2rem', flexDirection: isMobile ? 'column' : 'row' }}>
            <ul style={{ listStyle: 'none', display: 'flex', gap: isMobile ? '1.5rem' : '2rem', fontSize: isMobile ? '1.2rem' : '1.5rem', fontWeight: 600, flexWrap: 'wrap' }}>
              <li>
                <a href="https://github.com/tripathiji1312" target="_blank" rel="noreferrer" style={{ textDecoration: 'underline', cursor: 'pointer' }}>GITHUB</a>
              </li>
              <li>
                <a href="https://linkedin.com/in/swarnim-trip" target="_blank" rel="noreferrer" style={{ textDecoration: 'underline', cursor: 'pointer' }}>LINKEDIN</a>
              </li>
              <li>
                <a href="https://huggingface.co/tripathiji1312" target="_blank" rel="noreferrer" style={{ textDecoration: 'underline', cursor: 'pointer' }}>HUGGINGFACE</a>
              </li>
              <li>
                <a href="https://blog.swarnim.site/" target="_blank" rel="noreferrer" style={{ textDecoration: 'underline', cursor: 'pointer' }}>BLOG</a>
              </li>
            </ul>
